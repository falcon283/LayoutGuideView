#
#  Be sure to run `pod spec lint LayoutGuideView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name         = "LayoutGuideView"
  s.version      = "1.0.0"
  s.summary      = "A small Library to use UILayoutGuide from Interface Builder"
  ...
  s.homepage     = "https://github.com/falcon283/LayoutGuideView"
  ...
  s.source       = { :git => "https://github.com/falcon283/LayoutGuideView.git", :tag => s.version.to_s }
  ...
  s.source_files  = "LayoutGuideView/*.{swift}"
